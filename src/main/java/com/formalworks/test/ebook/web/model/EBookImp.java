...
//	private List<String> optionAppliedContents;
	...
	private Map<String, List<String>> previewContents;
	private int startLine = 0;
	private String startLineOfTableContentsByOrder;
	...
	@Override
	public Map<String, List<String>> getPreviewContents() {
		return previewContents;
	}

	@Override
	public void setPreviewContents(Map<String, List<String>> previewContents) {
	...
	@Override
	public String getTableOfContentsByOrderNum() {
		return startLineOfTableContentsByOrder;
	}

	@Override
	public void setTableOfContentsByOrderNum(String startLineOfTable) {
		this.startLineOfTableContentsByOrder = startLineOfTable;
	}
	
	@Override
	public void setCoverImg(String cover) {
