			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="#" style=" background-color:#fff "><i class="icon-edit"></i><span
								class="hidden-tablet"> <b><font color="#1294AB">STEP2 정보</font></b></span></a></li>
						<li><a class="ajax-link" href="#"><i
						...
						<li><a class="ajax-link" href="./option/confirm"><i class="icon-star"></i><span
								class="hidden-tablet">CONVERSION</span></a></li>
					</ul>
				</div>
				<!--/.well -->
			</div>
